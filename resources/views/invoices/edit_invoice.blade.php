                    ...
                    <form action="{{ url('invoices/update') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col">
                                ...
                                <select name="section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($sections as $section)
                                        <option @if ($invoice->section_id == $section->id) selected @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_vat" id="Rate_VAT" class="form-control" onchange="myFunction()"
                                    value="{{ $invoice->rate_vat }}">
                                    <!--placeholder-->
                                    <option value="" selected disabled>حدد نسبة الضريبة</option>
                                    <option @if ($invoice->rate_vat == '5%') selected @endif value="5%">5%</option>
                                    <option @if ($invoice->rate_vat == '10%') selected @endif value="10%">10%</option>
                                </select>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-12">
                            ...
                            <input type="file" name="pic" class="dropify"
                                accept=".pdf,.jpg, .png, image/jpeg, image/png" data-height="70" id="myFile" />
                        </div><br>
